...
addParagraph(homeTab, "Changelogs - ShinyHub", "ShinyHub 1.0 | Rayfield Gen2\nRemoved feedback webhook\nKept all auto features")
...
addParagraph(homeTab, "Credits", "Original: Space Hub | ShinyHub\nUI: Rayfield Gen2\nDont forget to join https://discord.gg/TtH3rBCyrv")
